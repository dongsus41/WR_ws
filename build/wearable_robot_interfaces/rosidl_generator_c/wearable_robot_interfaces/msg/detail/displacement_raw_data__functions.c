...
wearable_robot_interfaces__msg__DisplacementRawData__init(wearable_robot_interfaces__msg__DisplacementRawData * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    wearable_robot_interfaces__msg__DisplacementRawData__fini(msg);
    return false;
  }
  // displacement_raw
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->displacement_raw, 0)) {
    wearable_robot_interfaces__msg__DisplacementRawData__fini(msg);
    return false;
  }
  return true;
...
wearable_robot_interfaces__msg__DisplacementRawData__fini(wearable_robot_interfaces__msg__DisplacementRawData * msg)
{
  ...
  // displacement_raw
  rosidl_runtime_c__int32__Sequence__fini(&msg->displacement_raw);
}
...
wearable_robot_interfaces__msg__DisplacementRawData__are_equal(const wearable_robot_interfaces__msg__DisplacementRawData * lhs, const wearable_robot_interfaces__msg__DisplacementRawData * rhs)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__are_equal(
      &(lhs->displacement_raw), &(rhs->displacement_raw)))
  {
    return false;
  }
  return true;
  ...
  wearable_robot_interfaces__msg__DisplacementRawData * output)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__copy(
      &(input->displacement_raw), &(output->displacement_raw)))
  {
    return false;
  }
  return true;
...
wearable_robot_interfaces__msg__DisplacementRawData__create()
{
  ...
  wearable_robot_interfaces__msg__DisplacementRawData * msg = (wearable_robot_interfaces__msg__DisplacementRawData *)allocator.allocate(sizeof(wearable_robot_interfaces__msg__DisplacementRawData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(wearable_robot_interfaces__msg__DisplacementRawData));
  bool success = wearable_robot_interfaces__msg__DisplacementRawData__init(msg);
  if (!success) {
...
wearable_robot_interfaces__msg__DisplacementRawData__Sequence__init(wearable_robot_interfaces__msg__DisplacementRawData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  wearable_robot_interfaces__msg__DisplacementRawData * data = NULL;

  if (size) {
    data = (wearable_robot_interfaces__msg__DisplacementRawData *)allocator.zero_allocate(size, sizeof(wearable_robot_interfaces__msg__DisplacementRawData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = wearable_robot_interfaces__msg__DisplacementRawData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        wearable_robot_interfaces__msg__DisplacementRawData__fini(&data[i - 1]);
      }
...
wearable_robot_interfaces__msg__DisplacementRawData__Sequence__fini(wearable_robot_interfaces__msg__DisplacementRawData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      wearable_robot_interfaces__msg__DisplacementRawData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  wearable_robot_interfaces__msg__DisplacementRawData__Sequence * array = (wearable_robot_interfaces__msg__DisplacementRawData__Sequence *)allocator.allocate(sizeof(wearable_robot_interfaces__msg__DisplacementRawData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = wearable_robot_interfaces__msg__DisplacementRawData__Sequence__init(array, size);
  if (!success) {
...
wearable_robot_interfaces__msg__DisplacementRawData__Sequence__destroy(wearable_robot_interfaces__msg__DisplacementRawData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    wearable_robot_interfaces__msg__DisplacementRawData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
wearable_robot_interfaces__msg__DisplacementRawData__Sequence__are_equal(const wearable_robot_interfaces__msg__DisplacementRawData__Sequence * lhs, const wearable_robot_interfaces__msg__DisplacementRawData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!wearable_robot_interfaces__msg__DisplacementRawData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  wearable_robot_interfaces__msg__DisplacementRawData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(wearable_robot_interfaces__msg__DisplacementRawData);
    wearable_robot_interfaces__msg__DisplacementRawData * data =
      (wearable_robot_interfaces__msg__DisplacementRawData *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!wearable_robot_interfaces__msg__DisplacementRawData__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          wearable_robot_interfaces__msg__DisplacementRawData__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!wearable_robot_interfaces__msg__DisplacementRawData__copy(
