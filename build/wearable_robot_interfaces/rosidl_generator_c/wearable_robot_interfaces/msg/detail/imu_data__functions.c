...
wearable_robot_interfaces__msg__IMUData__init(wearable_robot_interfaces__msg__IMUData * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    wearable_robot_interfaces__msg__IMUData__fini(msg);
    return false;
  }
  // imu1
...
wearable_robot_interfaces__msg__IMUData__create()
{
  ...
  wearable_robot_interfaces__msg__IMUData * msg = (wearable_robot_interfaces__msg__IMUData *)allocator.allocate(sizeof(wearable_robot_interfaces__msg__IMUData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(wearable_robot_interfaces__msg__IMUData));
  bool success = wearable_robot_interfaces__msg__IMUData__init(msg);
  if (!success) {
...
wearable_robot_interfaces__msg__IMUData__Sequence__init(wearable_robot_interfaces__msg__IMUData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  wearable_robot_interfaces__msg__IMUData * data = NULL;

  if (size) {
    data = (wearable_robot_interfaces__msg__IMUData *)allocator.zero_allocate(size, sizeof(wearable_robot_interfaces__msg__IMUData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = wearable_robot_interfaces__msg__IMUData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        wearable_robot_interfaces__msg__IMUData__fini(&data[i - 1]);
      }
...
wearable_robot_interfaces__msg__IMUData__Sequence__fini(wearable_robot_interfaces__msg__IMUData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      wearable_robot_interfaces__msg__IMUData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  wearable_robot_interfaces__msg__IMUData__Sequence * array = (wearable_robot_interfaces__msg__IMUData__Sequence *)allocator.allocate(sizeof(wearable_robot_interfaces__msg__IMUData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = wearable_robot_interfaces__msg__IMUData__Sequence__init(array, size);
  if (!success) {
...
wearable_robot_interfaces__msg__IMUData__Sequence__destroy(wearable_robot_interfaces__msg__IMUData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    wearable_robot_interfaces__msg__IMUData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
wearable_robot_interfaces__msg__IMUData__Sequence__are_equal(const wearable_robot_interfaces__msg__IMUData__Sequence * lhs, const wearable_robot_interfaces__msg__IMUData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!wearable_robot_interfaces__msg__IMUData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  wearable_robot_interfaces__msg__IMUData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(wearable_robot_interfaces__msg__IMUData);
    wearable_robot_interfaces__msg__IMUData * data =
      (wearable_robot_interfaces__msg__IMUData *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!wearable_robot_interfaces__msg__IMUData__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          wearable_robot_interfaces__msg__IMUData__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!wearable_robot_interfaces__msg__IMUData__copy(
