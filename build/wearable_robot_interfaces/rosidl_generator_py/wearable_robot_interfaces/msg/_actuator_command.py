    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'wearable_robot_interfaces.msg.ActuatorCommand')
            logger.debug(
...
class ActuatorCommand(metaclass=Metaclass_ActuatorCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.pwm = array.array('B', kwargs.get('pwm', []))
    ...
    def pwm(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'pwm' array.array() must have the type code of 'B'"
            self._pwm = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'pwm' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._pwm = array.array('B', value)
