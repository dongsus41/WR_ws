...
bool wearable_robot_interfaces__msg__can_data_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wearable_robot_interfaces.msg._can_data_frame.CANDataFrame", full_classname_dest, 58) == 0);
  }
  wearable_robot_interfaces__msg__CANDataFrame * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CANDataFrame */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wearable_robot_interfaces.msg._can_data_frame");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CANDataFrame");
