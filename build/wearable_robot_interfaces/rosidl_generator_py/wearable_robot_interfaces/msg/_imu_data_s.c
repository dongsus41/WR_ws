...
bool wearable_robot_interfaces__msg__imu_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wearable_robot_interfaces.msg._imu_data.IMUData", full_classname_dest, 47) == 0);
  }
  wearable_robot_interfaces__msg__IMUData * ros_message = _ros_message;
  {  // header
...
PyObject * wearable_robot_interfaces__msg__imu_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wearable_robot_interfaces.msg._imu_data");
