...
bool wearable_robot_interfaces__msg__imu_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wearable_robot_interfaces.msg._imu_type.IMUType", full_classname_dest, 47) == 0);
  }
  wearable_robot_interfaces__msg__IMUType * ros_message = _ros_message;
  {  // roll
...
{
  /* NOTE(esteve): Call constructor of IMUType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wearable_robot_interfaces.msg._imu_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IMUType");
