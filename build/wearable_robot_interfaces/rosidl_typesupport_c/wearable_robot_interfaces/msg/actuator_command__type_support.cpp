...
static const _ActuatorCommand_type_support_symbol_names_t _ActuatorCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wearable_robot_interfaces, msg, ActuatorCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wearable_robot_interfaces, msg, ActuatorCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wearable_robot_interfaces, msg, ActuatorCommand)() {
  return &::wearable_robot_interfaces::msg::rosidl_typesupport_c::ActuatorCommand_message_type_support_handle;
}
