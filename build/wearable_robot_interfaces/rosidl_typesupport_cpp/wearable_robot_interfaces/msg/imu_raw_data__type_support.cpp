...
static const _IMURawData_type_support_symbol_names_t _IMURawData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wearable_robot_interfaces, msg, IMURawData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wearable_robot_interfaces, msg, IMURawData)),
  }
};
...
{
  return &::wearable_robot_interfaces::msg::rosidl_typesupport_cpp::IMURawData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wearable_robot_interfaces, msg, IMURawData)() {
  return get_message_type_support_handle<wearable_robot_interfaces::msg::IMURawData>();
}
