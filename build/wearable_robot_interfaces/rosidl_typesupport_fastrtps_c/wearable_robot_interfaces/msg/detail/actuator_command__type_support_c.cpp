...
#include "wearable_robot_interfaces/msg/detail/actuator_command__rosidl_typesupport_fastrtps_c.h"
...
using _ActuatorCommand__ros_msg_type = wearable_robot_interfaces__msg__ActuatorCommand;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: pwm
  {
    ...
    if (ros_message->pwm.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->pwm);
    }
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->pwm, size)) {
      return "failed to create array for field 'pwm'";
    }
    auto array_ptr = ros_message->pwm.data;
...
size_t get_serialized_size_wearable_robot_interfaces__msg__ActuatorCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ActuatorCommand__ros_msg_type * ros_message = static_cast<const _ActuatorCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ActuatorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wearable_robot_interfaces__msg__ActuatorCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wearable_robot_interfaces
size_t max_serialized_size_wearable_robot_interfaces__msg__ActuatorCommand(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_wearable_robot_interfaces__msg__ActuatorCommand(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wearable_robot_interfaces, msg, ActuatorCommand)() {
