...
#include "wearable_robot_interfaces/msg/detail/joint_state__rosidl_typesupport_fastrtps_c.h"
...
using _JointState__ros_msg_type = wearable_robot_interfaces__msg__JointState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: r_shoulder_angle
  {
    cdr << ros_message->r_shoulder_angle;
  }

  // Field name: l_shoulder_angle
  {
    cdr << ros_message->l_shoulder_angle;
  }

  // Field name: r_elbow_angle
  {
    cdr << ros_message->r_elbow_angle;
  }

  // Field name: l_elbow_angle
  {
...
size_t get_serialized_size_wearable_robot_interfaces__msg__JointState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointState__ros_msg_type * ros_message = static_cast<const _JointState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _JointState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wearable_robot_interfaces__msg__JointState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wearable_robot_interfaces
size_t max_serialized_size_wearable_robot_interfaces__msg__JointState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_wearable_robot_interfaces__msg__JointState(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wearable_robot_interfaces, msg, JointState)() {
