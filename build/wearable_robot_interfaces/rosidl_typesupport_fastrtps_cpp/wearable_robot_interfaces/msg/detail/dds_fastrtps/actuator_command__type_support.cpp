...
#include "wearable_robot_interfaces/msg/detail/actuator_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wearable_robot_interfaces::msg::ActuatorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wearable_robot_interfaces::msg::ActuatorCommand & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const wearable_robot_interfaces::msg::ActuatorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wearable_robot_interfaces::msg::ActuatorCommand *>(
    untyped_ros_message);
...
{
  return &wearable_robot_interfaces::msg::typesupport_fastrtps_cpp::_ActuatorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wearable_robot_interfaces, msg, ActuatorCommand)() {
  return &wearable_robot_interfaces::msg::typesupport_fastrtps_cpp::_ActuatorCommand__handle;
}
