...
#include "wearable_robot_interfaces/msg/detail/imu_raw_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wearable_robot_interfaces::msg::IMURawData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wearable_robot_interfaces::msg::IMURawData & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_wearable_robot_interfaces
max_serialized_size_IMURawData(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const wearable_robot_interfaces::msg::IMURawData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wearable_robot_interfaces::msg::IMURawData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IMURawData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wearable_robot_interfaces::msg::IMURawData *>(
...
{
  return max_serialized_size_IMURawData(full_bounded, 0);
}

static message_type_support_callbacks_t _IMURawData__callbacks = {
...
static rosidl_message_type_support_t _IMURawData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IMURawData__callbacks,
...
{
  return &wearable_robot_interfaces::msg::typesupport_fastrtps_cpp::_IMURawData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wearable_robot_interfaces, msg, IMURawData)() {
  return &wearable_robot_interfaces::msg::typesupport_fastrtps_cpp::_IMURawData__handle;
}
