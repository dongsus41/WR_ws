...
#include <stddef.h>
#include "wearable_robot_interfaces/msg/detail/temperature_data__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  wearable_robot_interfaces__msg__TemperatureData__init(message_memory);
}

void TemperatureData__rosidl_typesupport_introspection_c__TemperatureData_fini_function(void * message_memory)
{
  wearable_robot_interfaces__msg__TemperatureData__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TemperatureData__rosidl_typesupport_introspection_c__TemperatureData_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(wearable_robot_interfaces__msg__TemperatureData, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wearable_robot_interfaces__msg__TemperatureData, temperature),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers TemperatureData__rosidl_typesupport_introspection_c__TemperatureData_message_members = {
  ...
  2,  // number of fields
  sizeof(wearable_robot_interfaces__msg__TemperatureData),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wearable_robot_interfaces, msg, TemperatureData)() {
