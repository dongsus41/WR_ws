...
from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QHBoxLayout, QLabel, QSlider, QPushButton, QSpinBox, QWidget
...
class TemperatureControlWindow(QMainWindow):
    def __init__(self, node):
        ...
        self.current_temp_label.setStyleSheet("font-size: 16pt; font-weight: bold;")
        ...
        self.active_actuator = 5  # 기본값 (5번 구동기)
...
def main(args=None):
    ...
    node = rclpy.create_node('temperature_control_gui')

    app = QApplication(sys.argv)
    window = TemperatureControlWindow(node)
    window.show()
